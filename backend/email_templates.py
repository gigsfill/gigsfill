...
{{#is_countdown_reminder}}<p style="margin: 0 0 24px 0; font-size: 14px; line-height: 1.55; color: #92400e; background: #fef3c7; border: 1px solid #fcd34d; border-radius: 6px; padding: 12px 16px;"><strong>Heads up:</strong> this booking has been waiting for your response. The gig will stay unbooked until you approve or deny it. You'll get reminders at 3 days, 2 days, and 1 day before gig start.</p>{{/is_countdown_reminder}}
{{#is_weekly_reminder}}<p style="margin: 0 0 24px 0; font-size: 14px; line-height: 1.55; color: #92400e; background: #fef3c7; border: 1px solid #fcd34d; border-radius: 6px; padding: 12px 16px;"><strong>Still waiting on you:</strong> this booking request is open and the gig stays unbooked until you approve or deny it. We'll nudge you once a week until then, and again at 3 days, 2 days, and 1 day before gig start.</p>{{/is_weekly_reminder}}
