...
def update_venue(venue_id: int, data: dict, request: Request,
    ...
    params = {
        ...
        # COALESCE preserves the stored value; 0 or 1 → explicit toggle.
        "website_public": (None if data.get("website_public") is None
                           else (1 if bool(data.get("website_public")) else 0)),
