...
(function() {
  ...
  function renderTable(items) {
    ...
    //   • Unified column-header text to var(--text-gray) so the money
    //     columns don't visually shout compared to Gig Date/ID/Type.
    //     Cell VALUES keep their color coding.
    //   • "Total Pay" (previously "Venue Charge / Artist Paid") sits
    //     at the right end of the money breakdown, immediately before
    //     Processed — reads as the running-total of the row.
    //   • Extra padding on the Processed column so it breathes clear
    //     of the Total Pay column.
    $('apTable').innerHTML = `
      <table style="width:100%;border-collapse:collapse;font-size:0.72rem;">
        <thead>
          <tr style="background:rgba(255,255,255,0.03);border-bottom:1px solid var(--border);">
            ...
            <th title="GigsFill's fee for THIS side of the split. On the venue_charge row: the amount added on top of Gig Pay to reach the venue's total charge. On the artist_payout row: the amount deducted from Gig Pay to reach the artist's take-home. Both add up to the total platform commission." style="padding:7px 8px;text-align:right;font-weight:600;color:var(--text-gray);cursor:help;">GigsFill Fee</th>
            ...
            <th title="Row total: venue_charge row shows what's charged TO the venue's card (green, +). artist_payout row shows what's paid OUT to the artist (red, −). Trial rows show dashes — nothing moved through GigsFill." style="padding:7px 8px;text-align:right;font-weight:600;color:var(--text-gray);cursor:help;">Total Pay</th>
