...
async function loadArtistEarningsHistory() {
  ...
  try {
    ...
    window._artistEarnData = txns.map(function(t) {
      ...
      var statusTip = { transferred:'Transfer sent to your Stripe account — bank deposit in 1–2 business days', paid:'Deposited in your bank account', scheduled:'Scheduled for processing after the gig', pending:'Pending processing', charged:'Venue charged — transfer in progress', pending_transfer:'Payment processing — payout will arrive in 1–2 business days', charge_retry:'Retrying charge', payment_failed:'Payment issue — contact support', transfer_failed:'Transfer issue — contact support', upcoming:'Gig is upcoming — payout will process after the gig completes' };
